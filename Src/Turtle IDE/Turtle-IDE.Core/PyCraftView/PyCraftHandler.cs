...
namespace Turtle_IDE.Core
{
    ...
    [NewContent("Python files", 1, "Create a new Python file with PyCraft", "pack://application:,,,/Turtle-IDE.Core;component/Icons/pycraft.png")]
    internal class PyCraftHandler : IContentHandler
    {
        /// <summary>
        ...
        {
            var vm = _container.Resolve<PyCraftViewModel>();
            var model = _container.Resolve<PyCraftModel>();
            var view = _container.Resolve<PyCraftView>();
        ...
        public ContentViewModel OpenContent(object info)
        {
            ...
            if (location != null)
            {
                PyCraftViewModel vm = _container.Resolve<PyCraftViewModel>();
                var model = _container.Resolve<PyCraftModel>();
                var view = _container.Resolve<PyCraftView>();
        ...
        {
            var mdViewModel = contentViewModel as PyCraftViewModel;
            ...
            var mdModel = mdViewModel.Model as PyCraftModel;
